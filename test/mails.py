...
from tkinter import Tk, Label, Entry, Button, filedialog, Text, Toplevel, messagebox, Listbox, MULTIPLE, Scrollbar
import yaml
import os
import time
...
def send_emails():
    global emails_sent, current_account_index
    ...
    for index, row in df.iterrows():
        ...
        # Append to 'Sent' mailbox
        mail.select('"[Gmail]/Sent Mail"')
        mail.append('"[Gmail]/Sent Mail"', None, None, message.as_bytes())
        ...
        # Check if the limit is reached for the current account
